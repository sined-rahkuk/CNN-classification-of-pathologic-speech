# CNN-classification-of-pathologic-speech
[EN] TASK: Use KNN for binary classification of pathlogical speech (e.g. caused by disease). Compare results of models with and without parameters when training. Use existing dataset, such as Saarbrucken VD, PC-GITA or whatever you may find. Try to experiment with different of input pictures.
